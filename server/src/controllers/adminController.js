...
const adminController = {
  ...
  async getAllUsers(req, res) {
    try {
      const { data, error } = await serviceSupabase.from("users").select("*").order("created_at", { ascending: false })
  ...
  async deleteUser(req, res) {
    try {
      ...
      const { error } = await serviceSupabase.from("users").delete().eq("id", id)
  ...
  async deleteTemplate(req, res) {
    try {
      ...
      const { error } = await serviceSupabase.from("templates").delete().eq("id", id)
  ...
  async deleteResponse(req, res) {
    try {
      ...
      const { error } = await serviceSupabase.from("responses").delete().eq("id", id)
