...
export const fetchUserProfile = createAsyncThunk("auth/fetchProfile", async (userId, { rejectWithValue }) => {
  try {
...
export const updatePassword = createAsyncThunk("auth/updatePassword", async (password, { rejectWithValue }) => {
  try {
