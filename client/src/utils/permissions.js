...
export const PERMISSIONS = {
  ...
  [ROLES.EDITOR]: ["templates:create", "templates:read", "templates:update", "templates:delete", "users:read"],
  [ROLES.USER]: ["templates:create", "templates:read", "templates:update:own", "templates:delete:own"],
  [ROLES.GUEST]: ["templates:read:public"],
}
