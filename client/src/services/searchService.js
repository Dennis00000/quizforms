...
class SearchService {
  ...
  async searchTemplates(query, options = {}) {
    try {
      ...
      const { limit = 10, category = null, sortBy = "created_at", sortOrder = "desc" } = options
  ...
  async searchSubmissions(query, options = {}) {
    try {
      ...
      const { limit = 10, templateId = null, status = null, sortBy = "created_at", sortOrder = "desc" } = options
  ...
  async searchUsers(query, options = {}) {
    try {
      ...
      const { limit = 10, role = null, sortBy = "created_at", sortOrder = "desc" } = options
