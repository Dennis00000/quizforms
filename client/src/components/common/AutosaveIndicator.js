 ...
 */
const AutosaveIndicator = ({ lastSaved, isSaving, error, isEnabled, onToggle, onManualSave }) => {
  return (
    <div className="flex items-center space-x-2 text-sm">
      <div className="flex items-center">
        ...
        <div className="relative inline-block w-10 align-middle select-none">
          <input type="checkbox" id="autosave-toggle" checked={isEnabled} onChange={onToggle} className="sr-only" />
