...
const Button = ({
  ...
  const variantClasses = {
    ...
    secondary:
      "bg-gray-300 hover:bg-gray-400 text-gray-900 focus:ring-gray-400 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white",
    danger: "bg-red-600 hover:bg-red-700 text-white focus:ring-red-500",
    success: "bg-green-600 hover:bg-green-700 text-white focus:ring-green-500",
    warning: "bg-yellow-500 hover:bg-yellow-600 text-white focus:ring-yellow-400",
    info: "bg-blue-500 hover:bg-blue-600 text-white focus:ring-blue-400",
    outline:
      "bg-transparent border border-gray-400 text-gray-800 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800",
  ...
  if (to) {
    return (
      <Link to={to} className={buttonClasses} aria-label={ariaLabel || children} title={tooltip} {...rest}>
        {content}
      </Link>
    )
  }
