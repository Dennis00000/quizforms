...
const Card = ({
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg ${className}`} {...rest}>
      {(title || subtitle) && (
      ...
      <div className={`${noPadding ? "" : "px-4 py-5 sm:p-6"} ${bodyClassName}`}>{children}</div>
