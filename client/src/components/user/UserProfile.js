  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        {isEditing ? (
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6">
              <div className="flex flex-col items-center">
                <div className="relative mb-2">
                  <Avatar src={avatarPreview || user.avatar_url} alt={user.name} size="xl" />
                  <label
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">{t("profile.changeAvatar")}</span>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="mb-4">
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t("profile.emailChangeNotice")}</p>
                </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              <div className="mb-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">{t("profile.nameLabel")}</h3>
                <p className="mt-1">{user.name}</p>
              </div>

              <div className="mb-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">{t("profile.emailLabel")}</h3>
                <p className="mt-1">{user.email}</p>
              </div>

              <div className="mb-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">{t("profile.bioLabel")}</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-red-200 dark:border-red-900">
        <h2 className="text-xl font-semibold mb-4 text-red-600 dark:text-red-400">{t("profile.deleteAccount")}</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-300">{t("profile.deleteWarning")}</p>
      ...
      <Modal isOpen={showDeleteModal} onClose={() => setShowDeleteModal(false)} title={t("profile.deleteAccount")}>
        <div className="p-6">
          <p className="mb-6 text-gray-700 dark:text-gray-300">{t("profile.deleteConfirm")}</p>
          <div className="flex justify-end gap-3">
