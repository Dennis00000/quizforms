...
const ProfileManagement = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
      <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">{t("profile.title")}</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">{t("profile.avatarHelp")}</p>
        </div>
