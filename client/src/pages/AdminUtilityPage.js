    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="mb-4">
          ...
          <p>
            <strong>Role:</strong>{" "}
            <span className={userRole === "admin" ? "text-green-600 font-bold" : ""}>{userRole || "N/A"}</span>
          </p>
          <p>
      ...
      <div className="mt-8 bg-yellow-50 dark:bg-yellow-900 border-l-4 border-yellow-400 p-4 rounded">
        <p className="text-yellow-700 dark:text-yellow-200">
          <strong>Note:</strong> This utility page is for testing purposes only. In a production environment, you would
          want to implement proper role management with additional security measures.
        </p>
      </div>
    </div>
  )
