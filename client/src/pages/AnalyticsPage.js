        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">{t("analytics.userGrowth")}</h2>
          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">{t("analytics.templatesByTopic")}</h2>
              <div className="mt-4 h-64">
          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">{t("analytics.activityByDay")}</h2>
              <div className="mt-4 h-64">
          ...
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white">{t("analytics.popularTemplates")}</h2>
              <div className="mt-4">
                <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                  {analytics.popularTemplates.map((template, index) => (
                    <li key={template.id} className="py-4">
                      <div className="flex items-center">
                        <span className="text-gray-500 dark:text-gray-400 w-8 text-center">{index + 1}</span>
                        <div className="ml-3">
