  ...
  if (error || !template) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
        <h1 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-4">{t("templates.notFound")}</h1>
        <p className="text-gray-700 dark:text-gray-300 mb-6">{t("templates.notFoundDescription")}</p>
        <Link
          to="/templates"
      ...
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg mb-8">
        <div className="px-4 py-5 sm:px-6 flex justify-between items-start">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              {liked ? <HeartSolid className="h-6 w-6" /> : <HeartOutline className="h-6 w-6" />}
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
          {template.description && (
            <div className="mb-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t("templates.description")}</h2>
              <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line">{template.description}</p>
            </div>
          )}

          {template.tags && template.tags.length > 0 && (
            <div className="mb-6">
              <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-2">{t("templates.tags")}</h2>
          ...
          <div>
            <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-4">{t("templates.questions")}</h2>
            ...
            {template.questions && template.questions.length > 0 ? (
                    ...
                    <div className="ml-6">
                      ...
                      {question.type === "scale" && (
                        <div className="mt-2">
                          ...
                          <input type="range" min="1" max="10" disabled className="mt-1 w-full max-w-md" />
                        </div>
                      )}
              ...
              <p className="text-gray-500 dark:text-gray-400">{t("templates.noQuestions")}</p>
            )}
          </div>
        </div>
      </div>
