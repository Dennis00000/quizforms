...
const TemplateEditPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">{t("templates.edit")}</h1>

      {template && <TemplateForm initialData={template} onSubmit={handleSubmit} isEditing={true} />}
    </div>
  )
}
