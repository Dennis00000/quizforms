      ...
      <div className="border-b border-gray-200 dark:border-gray-700 mb-6">
        <nav className="-mb-px flex space-x-8">
          ...
          {activeTab === "search" && searchQuery && (
            <button className="border-primary-500 text-primary-600 dark:text-primary-400 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm inline-flex items-center">
        ...
        <>
          ...
          {hasMore && (
            <div className="mt-8 flex justify-center">
              ...
              >
                {loading ? <LoadingSpinner size="sm" /> : t("common.loadMore", "Load More Templates")}
              </button>
            </div>
          )}
        </>
