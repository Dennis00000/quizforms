    ...
    <MainLayout>
      <div className="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">{t("form.submission.successMessage")}</p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
            ...
            {navigator.share && (
              <Button onClick={shareSubmission} variant="secondary" className="flex items-center justify-center">
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
                  stroke="currentColor"
