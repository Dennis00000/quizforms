    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <TagInput tags={template.tags} onChange={handleTagsChange} placeholder={t("templates.tagsPlaceholder")} />
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6">
          ...
          <QuestionBuilder questions={template.questions} onChange={handleQuestionsChange} />
        </div>
        ...
        <div className="flex justify-end space-x-3">
          ...
          >
            {loading ? <LoadingSpinner size="sm" color="white" /> : t("templates.create")}
          </button>
        </div>
      </form>
    </div>
