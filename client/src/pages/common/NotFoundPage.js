...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6">{t("notFound.title")}</h2>
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-md">{t("notFound.message")}</p>
